...
function OrderSummary() {
  ...
  const { funnyStory, songMood, songStyle, songTempo, instruments, story } = savedFormData;
  const orderSummary = { funnyStory, songMood, songStyle, songTempo, instruments, story };
